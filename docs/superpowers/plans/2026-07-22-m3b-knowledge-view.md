...
describe("KgGraphView", () => {
  ...
  it("positions an importer strictly after what it imports", () => {
    ...
    // a.py imports b.py imports c.py: a.py is the top-level importer, c.py is
    // the pure leaf dependency nothing imports further. The importer must
    // land after what it imports, same convention DagView already
    // established for WorkUnit dependencies.
